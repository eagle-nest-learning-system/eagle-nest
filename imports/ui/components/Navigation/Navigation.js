...
export default connect(mapStateToProps, navigationActions)(class Navigation extends Component {
  ...
  render() {
    const { 
      viewportWidth, 
      navigationHeight 
    } = this.props, isMobile = viewportWidth < theme.breakpoints.values.sm;
